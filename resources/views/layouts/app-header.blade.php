...
<header
    ...
    <div class="flex w-full flex-col items-center justify-between gap-4 px-3 py-3 xl:flex-row xl:px-6 lg:py-4">
        <div class="flex w-full items-center justify-between gap-3 xl:w-auto xl:justify-start">
            <div class="flex items-center gap-3">
                <button
                    class="hidden xl:flex h-10 w-10 items-center justify-center rounded-xl border border-gray-200 text-gray-500 dark:border-gray-800 dark:text-gray-400"
                ...
                <button
                    class="flex h-10 w-10 items-center justify-center rounded-xl text-gray-500 dark:text-gray-400 xl:hidden"
            ...
            <a href="{{ route('dashboard') }}" class="flex items-center gap-3 xl:hidden">
                ...
                <span class="text-sm font-semibold text-gray-900 dark:text-white">WebStellar ERP</span>
            </a>
        </div>
        ...
        <div class="flex w-full items-center gap-3 xl:max-w-xl">
            <div class="relative hidden grow xl:block">
                ...
                <input type="text" placeholder="Cari menu atau modul ERP..."
                    class="h-11 w-full rounded-xl border border-gray-200 bg-white py-2.5 pl-12 pr-20 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-800 dark:bg-white/[0.03] dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" />
                <span
                    class="absolute right-3 top-1/2 inline-flex -translate-y-1/2 rounded-lg border border-gray-200 bg-gray-50 px-2 py-1 text-[11px] font-medium text-gray-500 dark:border-gray-800 dark:bg-white/[0.03] dark:text-gray-400">
                    Ctrl K
                </span>
            </div>
